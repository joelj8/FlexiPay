...
namespace FlexiPay.WebApi.Repository
{
    public class MFacturaProfile : Profile
    {
        public MFacturaProfile()
        {
            ...
            .ForMember(dest => dest.AprobacionNumero, opts => opts.MapFrom(src => src.AprobacionNumero != null ? src.AprobacionNumero : " " ))
            .ForMember(dest => dest.Comentario, opts => opts.MapFrom(src => src.Comentario != null ? src.Comentario : " " ))
            ...
            .ForMember(dest => dest.TarjetaID, opts => opts.MapFrom(src => src.TarjetaID != 0 ? src.TarjetaID : 1))
